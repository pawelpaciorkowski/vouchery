...
export const UserList = () => {
    ...
    const handleDelete = async (userId: number, username: string) => {
        ...
        try {
            ...
            // Usuwamy użytkownika z listy na frontendzie bez przeładowania strony
                ...
                <table className="w-full text-sm border-collapse border">
                    <thead className="bg-gray-100">
                        <tr>
                            ...
                            <th className="border px-2 py-2 text-left">Akcje</th> {/* Nowa kolumna */}
                        </tr>
                    </thead>
                    <tbody>
                        {users.map(user => (
                            <tr key={user.id} className="hover:bg-gray-50">
                                ...
                                <td className="border px-2 py-1">
                                    ...
                                    <button
                                        ...
                                        disabled={user.role === 'superadmin'} // Wyłącz przycisk dla superadmina
                                    >
                                        Usuń
                                    </button>
                                </td>
